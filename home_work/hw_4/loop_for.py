...
for i in range(b - a):  # количество чисел между А и В (включительно)
    sum_numbers += a + i + 1  # сумма чисел между А и В (включительно)

print(f"Сумма всех целых чисел от {a} до {b} включительно: {a + sum_numbers}")
