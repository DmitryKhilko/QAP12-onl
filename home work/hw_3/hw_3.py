...
number_1 = -1.6
number_2 = 2.99
print('Исходное число', number_1, '; число, приведенное к целому типу: ', int(number_1))
print('Исходное число', number_2, '; число, приведенное к целому типу: ', int(number_2))
...
print("Необходимо заменить символ '", symbol_old, "' на символ '", symbol_new, "' в строке '", string_old, "'")
...
# Задание 5. Напишите программу, которая удаляет пробел в начале, в конце строки
print('')
print('Задание 5')

string_old = ' Мама мыла мылом раму '
string_new = string_old.strip()
print("Необходимо удалить начальные и конечные пробелы в строке '", string_old, "'")
print("Строка без начальных и конечных пробелов в строке '", string_new, "'")

# Задание 6. Создайте словарь, связав его с переменной school, и наполните его данными которые бы отражали количество
# учащихся в десяти разных классах (например, 1а, 1б, 2б, 6а, 7в и т.д.).
print('')
print('Задание 6')

school = {'1a': 20, '1б': 18, '1в': 23, '1г': 21, '2а': 20, '2б': 19, '2в': 24, '2г': 22, '3а': 25, '3б': 24}
...
# Задание 10. Есть массив чисел. Известно, что каждое число в этом массиве имеет пару, кроме одного:
